...
* Use the command palette (cmd-shift-P) to run 'CMake: Delete cache and reconfigure'
* Use the command palette (cmd-shift-P) to run 'CMake: Build'
* Check that you can run the test in the 'Testing' (flask icon) side panel
